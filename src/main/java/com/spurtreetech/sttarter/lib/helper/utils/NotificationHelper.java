    ...
    public static void displayNotification(String groupsString) {
        ...
        while (!tempCursor.isAfterLast()) {
            ...
            if(bigText.equals("")) {
                ...
                Log.d("NotificationHelper", "column index - " + tempCursor.getString(0) + ", " + tempCursor.getString(1) + ", " + tempCursor.getString(2) + ", TopicName " + tm.getName());
        ...
        builder.setContentTitle("IndusEdge")
