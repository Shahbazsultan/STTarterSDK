...
//	  cause.printStackTrace();
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        ...
        if(pd.getType().equals("system")) {
            ...
            MessagesCursor messageCursor = ph.findMessage(pd.getPayload().getMessage(), pd.getPayload().getTopic(), Long.parseLong(pd.getTimestamp()));
                ...
                if(STTarter.isApplicationSentToBackground()) {
                    ...
                    if(tc.getCount()!=0) {
                        ...
                        if(notificationString.equals("")) {
                            notificationString = (tm.getName()==null || tm.getName().equals("")) ? "Buzz" : tm.getName();
                        } else {
                            notificationString += ", " + ((tm.getName()==null || tm.getName().equals("")) ? "Buzz" : tm.getName());
                        }
